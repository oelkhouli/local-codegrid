...
- No external AI explanation service, Kubernetes, Terraform, billing, dependency downloads, arbitrary compiler flags, interactive stdin, file uploads, or secret test judging. Compiler messages are available without an API key.
