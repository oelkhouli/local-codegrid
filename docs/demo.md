...
6. **4:15–5:00 — Explain one hard decision.** Open the cleanup algorithm. Explain why physical cleanup must precede releasing capacity, then state the container/shared-kernel limitation and identify one improvement you would make next.
